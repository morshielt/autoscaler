...
func (o *ScaleUpOrchestrator) ScaleUp(
	...
	plan, st, aErr := o.planScaleUp(scaleUpCtx{
...
func (o *ScaleUpOrchestrator) planScaleUp(args scaleUpCtx) (scaleUpPlan, *status.ScaleUpStatus, errors.AutoscalerError) {
	...
	if aErr != nil {
		st, err := status.UpdateScaleUpError(&status.ScaleUpStatus{PodsTriggeredScaleUp: bestOption.Pods}, aErr)
